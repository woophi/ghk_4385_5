...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', 'activate_4385_var5');
    setLoading(true);
      ...
      <div className={appSt.container}>
        ...
        <div className={appSt.boxRow2}>
          ...
          <ButtonMobile
            ...
            view="secondary"
            onClick={() => {
              window.gtag('event', 'add_4385_var5');
              setAdd(!added);
            }}
          >
        ...
        <div>
          <div className={appSt.rowText} onClick={() => window.gtag('event', 'FAQ_4385_var5')}>
            <CDNIcon name="glyph_question-circle_m" />
            <Typography.Text view="primary-medium">Частые вопросы</Typography.Text>
          </div>
          <div className={appSt.rowText} onClick={() => window.gtag('event', 'more_4385_var5')}>
